...
# Configuration Script – VS133 3D - Rev. A

This **Configuration** script is designed for the **VS133 3D** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – VS133 3D Rev. A

Este script de **Configuration** está diseñado para el modelo **VS133 3D** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
